        ...
        <form className="cex-search-bar" >
            <div class="flex flex-col gap-y-2 md:flex-row ">
                ...
                <div class="relative w-full">
                    ...
                    <button type="submit" class={ nunito.className + " absolute top-0 right-0 px-5 p-3 text-sm font-medium text-white bg-red-500 border border-red-500 hover:bg-red-800 hover:border-red-800"}>
